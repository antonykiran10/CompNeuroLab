...
def model(z, t):
    ...
    dzdt = [dm0dt, dm1dt, dm2dt, dc0dt, dc1dt, dB0dt, dB1dt, dhdt, dca_cytdt, dca_erdt, dIP3dt]
    return dzdt


initial_vals = [0, 0, 0, 0, 0, 0, 0, 0, 0.08, 400, 0.16]  # [mo, m1, m2, c0, c1, B0, B1, h, ca_cyt, ca_er, IP3, Glu]

time_points = np.linspace(0, 200, int(200 / 0.00005))

result = odeint(model, initial_vals, time_points)
# plt.scatter(result[:, 11], time_points)
# plt.show()
