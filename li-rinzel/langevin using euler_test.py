...
def dh(cal_cyto, IP3_conc, h):
    ...
    value_of_h = ((alpha_h * (1 - h) - beta_h * h))*dt + np.random.normal(loc=0.0, scale=std_dev)
...
# df.to_csv("/home/antony/mycodes/li-rinzel/data_langevin/output_" +  "_current" + ".csv", index=False)
    # print(i)
